...
public class BibliotecaService {
        ...
        // /libro
        public void getLibros() { //Obtener todos los libros
        ...
        public void getLibros(int page, int size, String title, String estado) {                //Búsqueda parametrizada
                PageLibro libros = webClient.get()
                                .uri("/libros?page={page}&size={size}&titulo={title}&estado={estado}", page, size, title, estado)
                                .retrieve()
                                .onStatus(HttpStatusCode::is4xxClientError, response -> response
                                                .bodyToMono(String.class)
                                                .doOnNext(body -> System.err.println("Error 4xx: " + body))
                ...
                for (Libro libro : libros.get_embedded().getLibrosList()) {
                        System.out.println(
                                        "El libro "+ libro + " se encuentra disponible en el enlace: "
        ...
        public void postEjemplar(int libroId, String Estado) {
                ...
                try {
                        String referencia = webClient.post()
                                        .uri("/libros/{libro-id}/ejemplares", libroId)
                                        .contentType(MediaType.APPLICATION_JSON)
        ...
        public void postPrestamo(int matricula, String fechaInicio) {
